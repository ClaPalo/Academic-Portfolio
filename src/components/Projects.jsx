...
function Projects(props) {
    return (
        <div className="flex flex-col h-screen pt-0 snap-start snap-always noScrollbar scroll-smooth justify-center items-center p-10">
            <Waypoint onEnter={() => props.waypointCallback("4")} />
            <h1 className="text-6xl font-bold mb-10 mt-0">
                Projects
            </h1>
